        ...
        <Fragment>
            <div className="container-fluid addEmp align-items-center flex-column">
                ...
                <form method="POST"  encType='multipart/form-data'>
                    <div className='row row-cols-1 row-cols-md-12 d-flex justify-content-center logintxt regformwidth'>
                        <div className='col col-md-5 mb-2'><input onChange={(e)=>{this.setState({name : e.target.value})}} autocomplete="off" className="form-control form-control-sm" type="text" placeholder="First & Last Name" aria-label=".form-control-sm example" /></div>
                        ...
                        <div className='col col-md-5 mb-2'><input onChange={(e)=>{this.setState({dateofbirth : e.target.value})}} data-bs-toggle="tooltip" data-bs-placement="left" data-bs-custom-class="custom-tooltip" data-bs-title="Insert User Birth Date." autocomplete="off" className="form-control form-control-sm" type="date" placeholder="Date of Birth" aria-label=".form-control-sm example" /></div>
                        <div className='col col-md-5 mb-2'><input onChange={(e)=>{this.setState({nid : e.target.value})}} autocomplete="off" className="form-control form-control-sm" type="number" min="1" placeholder="Nid Number" aria-label=".form-control-sm example" /></div>
                        ...
                        <div className='col col-md-5 mb-2'><input onChange={(e)=>{this.setState({joined : e.target.value})}} data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Insert Joining Date Here." autocomplete="off" className="form-control form-control-sm" type="date" placeholder="Joining Date" aria-label=".form-control-sm example" /></div>
                        ...
                        <div className='col col-md-5 mb-2'><input onChange={(e)=>{this.setState({image : e.target.files[0]})}} data-bs-toggle="tooltip" data-bs-placement="right" data-bs-custom-class="custom-tooltip" data-bs-title="Insert User Profile Image jpg or jpeg Here." className="form-control form-control-sm" id="formFileSm" type="file" /></div>
                        
                        <div className='col col-md-5 mb-2'><input onChange={(e)=>{this.setState({designation : e.target.value})}} autocomplete="off" className="form-control form-control-sm" type="text" placeholder="Designation" aria-label=".form-control-sm example" /></div>
                        <div className='col col-md-5 mb-2'><input onChange={(e)=>{this.setState({sallery : e.target.value})}} autocomplete="off" className="form-control form-control-sm" type="number" min="1000" placeholder="Sallery" aria-label=".form-control-sm example" /></div>

                        <div className='col col-md-5 mb-2'><input onChange={(e)=>{this.setState({password : e.target.value})}} value={this.state.password} autocomplete="off" className="form-control form-control-sm" type="text" placeholder="Password" aria-label=".form-control-sm example" /></div>
                        <div className='col col-md-5 mb-2'><button onClick={(e)=>{this.genPass(e)}} type="button" class="btn btn-sm btn-outline-info"><KeyIcon /> Generate Password</button></div>
                        
                        
                        <div className='col col-md-10 d-flex justify-content-center mt-3 mb-3'><button onClick={(e)=>{this.regEmp(e)}} type="button" class="btn btn-sm btn-outline-info"><AppRegistrationIcon /> Add Employee</button></div>
                    </div>
                </form>
            </div>
            ...
            <div className='container-fluid editEmp d-flex flex-column p-5'>
                <div className='row row-cols-1 row-cols-md-12 d-flex justify-content-center logintxt mb-0 p-0 align-items-center'>
                    <div className='col col-md-12 mb-5 alertshadw d-flex justify-content-center'>All Employees List :</div>
                </div>
