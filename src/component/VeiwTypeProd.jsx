...
export class ViewTypeProd extends Component {
    constructor(props) {
        super(props);
        this.state = {
            currentPage: 1,
    ...
    async componentDidMount(){
        ...
        console.log(sln)
        try{
            const res = await axios.get(`/getTypePrd/${sln}`,{
                headers : {
    ...
    return (
        ...
        <div className='row row-cols-1 row-cols-md-12 d-flex justify-content-center logintxt mb-0 p-0 align-items-center'>
            <div className='col col-md-12 mb-5 alertshadw d-flex justify-content-center homeptsz'>All Products of This Type :</div>
        </div>
