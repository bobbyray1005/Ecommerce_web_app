...
export class ViewTerms extends Component {
  render() {
    return (
        <Fragment>
            <div className='container-fluid viewterms d-flex justify-content-center'>
            <div className='row row-cols-1 row-cols-md-8 p-4 d-flex justify-content-center'>
            <div className='col col-md-6 d-flex justify-content-center p-5 policy flex-column fontterm'><b><span className='undrln'>The Rules & User Policy :</span></b><br></br>During Registration You Must Put Valid Data In Order To Protect Account & Future Account Optimizations And Password Recovery. Also Kindly When Posting Insert Data In Al Of The Form Fields.<br></br>All Your Password And Account Information Is Safe With Us And We Use Password As Hashed Form So There Is No Need To Worry About Safety.<br></br><br></br><b><span className='undrln'>Effective Date: [7-16-2023]</span></b><br></br>
